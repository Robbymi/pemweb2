...
<body>
  <div class="container">
    ...
    <div class="container-fluid mt-2">
      <h1 class="container text-center">Form</h1>
      <div class="row">
        <div class="col-12">
            ...
            <form method="post" action="">
              ...
              <div class="form-group row">
                <div class="offset-4 col-8">
                  <button type="submit" name="tombol" class="btn btn-success">Submit</button>
                </div>
              </div>
            </form>
          </div>
    ...
    <footer style="position:relative;" class="bottom-0  container mt-4">
